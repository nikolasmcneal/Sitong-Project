...
jsPsych.plugins["blocks"] = (function () {
  ...
  plugin.trial = function (display_element, trial) {
    ...
    new_html += '<canvas id="canvas-border-left"  height="' + 250 + '" width="' + 250 + '"style = "padding: 0; margin: auto; display: block; width = 360px; height = 225px; position: absolute; top: 0; bottom: 0; left: -700px; right: 0; text-align: center;" ></canvas>'
    new_html += '<canvas id="canvas-border-right" height="' + 250 + '" width="' + 250 + '"style = "padding: 0; margin: auto; display: block; width = 360px; height = 225px; position: absolute; top: 0; bottom: 0; left: 700px; right: 0; text-align: center;" ></canvas>'
    //new_html += '</div>'
    ...
    var display_selection = function () {
      ...
      if (String.fromCharCode(response.key) == trial.choices[0].toUpperCase()) {
        ...
        $(selected).css('border', `18px solid gold`);
